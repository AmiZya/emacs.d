...
- [[#bootstrap][Bootstrap]]
  - [[#easily-edit-config-file][Easily edit config file]]
...
** Blogging
Configuration for blogging using Hugo
...
#+end_src
** Treemacs
Directory and files explorer like NERDTree
